...
public class TC31TestSearchINBowrodBooksINVALIdData {

	TC31TestSearchINBowrodBooksINVALIdData() {
		...
		WebDriver driver =new FirefoxDriver();
			...
			driver.findElement(By.cssSelector("#example_filter > label > input[type=text]")).sendKeys("3737jkd");
	}
