...
public class TC11testserchadvancedsearchvaliddata {

	TC11testserchadvancedsearchvaliddata() {
		...
		WebDriver driver =new FirefoxDriver();
			...
			driver.findElement(By.name("author")).sendKeys("Baker");
			driver.findElement(By.cssSelector("#myModal > div.modal-body > form > div:nth-child(3) > div > button")).click();
	}
